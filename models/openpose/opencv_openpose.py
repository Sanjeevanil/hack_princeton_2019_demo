...
if __name__ == "__main__":
    ...
    frame = cv2.imread("images/test/650x350_the_health_benefits_of_yoga_ref_guide.jpg")
    ...
    cv2.imwrite("images/test/Output-Keypoints.jpg", frameCopy)
    cv2.imwrite("images/test/Output-Skeleton.jpg", frame)
